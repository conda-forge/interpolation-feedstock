...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/interpolation-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/interpolation-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add interpolation
# for installing globally
pixi global install interpolation
```
...
It is possible to list all of the versions of `interpolation` available on your platform:
...
```
pixi search interpolation --channel conda-forge
```
